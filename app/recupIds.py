#Récupérations des Ids présent dans le cache
#Génération d'un fichier avec les ids des stations de l'API
...
if isinstance(data_list, list):
    ...
    for item in data_list:
        # Vérification si une clé id
        if 'id' in item:
            # Ajout des ids à la liste
